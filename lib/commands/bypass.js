...
async function handleBypass(interaction, res) {
  ...
  const content = mode === 'on'
    ? `✅ Dev bypass **AKTIF** untuk ${targetLabel} — cooldown stamina, overdue loan, limit order, cooldown /leak, dan cooldown/limit klaim bank akan diabaikan (bunga tetap dihitung jujur, tidak dipercepat).`
