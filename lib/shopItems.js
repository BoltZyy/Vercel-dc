...
const SHOP_ITEMS = {
   ...
   * -------------------------------------------------------------------- */
  INSIDER_PASS: {
    // Rename dari LEAK_TOKEN (nama lama) — lihat scripts/migrate-item-renames.js
    // untuk migrasi data existing di trading:inventory:{userId}.
    id: 'INSIDER_PASS',
    name: '🕵️ Insider Pass',
    description: 'Buka Alpha Intel eksklusif di /leak (info pergerakan koin spesifik) dan reset cooldown /leak secara instan.',
    price: 5000,
    category: 'utility',
    type: 'consumable',
  },
  ADVANCED_PASSCARD: {
    // Rename dari BANK_PASSCARD (nama lama) — lihat scripts/migrate-item-renames.js
    // untuk migrasi data existing di trading:inventory:{userId}.
    id: 'ADVANCED_PASSCARD',
    name: '🎟️ Advanced Passcard',
    description: 'Mencairkan deposito bank instan + bunga penuh tanpa nunggu jatuh tempo, ATAU instant-claim bunga Tabungan Reguler tanpa cooldown 24 jam (Maksimal 2x pakai per hari, gabungan kedua penggunaan).',
    price: 2500,
    category: 'utility',
    type: 'consumable',
  },
